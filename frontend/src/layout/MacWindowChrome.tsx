...
export default function MacWindowChrome({ path, children, onActivate, x, y, width, height, maximized = false, isActive = false }: Props) {
  const { activateWindow, updateWindowPosition, updateWindowSize } = useWindowManager();
