...
export const modelRegistry: ModelRegistration[] = [
  ...
  { app: "transactions", model: "purchase_order", label: kebabCaseToTitle("purchase_order") },
  { app: "transactions", model: "purchase_order_line", label: kebabCaseToTitle("purchase_order_line") },
