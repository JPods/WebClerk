...
class WorkOrderPhase1Tests(TestCase):
    def setUp(self):
        ...
        Setting.objects.create(purpose='wc:view_edit', model_target='work_order', is_active=True,
                               data={'USER': {'view': ['id','work_no','status'], 'edit': ['id','status']}})
        Setting.objects.create(purpose='wc:view_edit', model_target='work_order_line', is_active=True,
