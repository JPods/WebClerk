...
export default function EmployeeList() {
  ...
  const [selectedEmployee, setSelectedEmployee] = useState<dynamicData | null>(
    null
  );
  ...
  const getLocationData = useCallback(async (employeeId?: number) => {
    setLoading(true);
    try {
      ...
      if (employeeId) {
        const contactRes = await getRecord("employee", employeeId);
        setSelectedEmployee(contactRes.record);
