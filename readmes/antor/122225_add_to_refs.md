...
- **Files changed / added**:
  - `apps/core/services/wcapi.py` — implemented auto-linking logic inside `save_item` after creates
  - `apps/transactions/views/wcapi.py` — delegates save to `apps.core.services.wcapi.save_item` to centralize behavior
