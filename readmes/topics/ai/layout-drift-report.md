...
> Generated: 2026-08-19 23:08  
> Models scanned: 18  
> Total issues (excl. info): 347

## Changes Since Last Scan

### ✅ Resolved (1)

- ~~contact:comment:unrendered_field~~

### 🆕 New Issues (1)

- document:comment:phantom_field

*346 issues unchanged from last run.*

**Trend:** ➡️ stable (200 total corrections over 24 scans)

## Summary

| Severity | Count |
|----------|-------|
| 🔴 High (phantom fields) | 17 |
| 🟡 Medium (required unrendered) | 9 |
| 🔵 Low (optional unrendered) | 321 |
...
Django fields: 53 | Pages: detail(1)
...
Django fields: 37 | Pages: display(1)
...
- 🔴 **comment** (`phantom_field`): Layout references 'comment' but Django model has no such field. Found in: display
  - 💡 *Remove the field reference from the React component, or add a matching field to the Django model.  If this is a UI-only field (e.g., password confirmation), dismiss it with --dismiss.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss document:comment:phantom_field`
...
- 🔵 **content** (`unrendered_field`): Django has 'content' (TextField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss report:content:unrendered_field`
...
- 🔵 **editor_type** (`unrendered_field`): Django has 'editor_type' (CharField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss report:editor_type:unrendered_field`
- 🔵 **explanation** (`unrendered_field`): Django has 'explanation' (TextField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss report:explanation:unrendered_field`
- 🔵 **is_locked** (`unrendered_field`): Django has 'is_locked' (BooleanField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
...
- 🔵 **paths** (`unrendered_field`): Django has 'paths' (JSONField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss report:paths:unrendered_field`
- 🔵 **purpose** (`unrendered_field`): Django has 'purpose' (CharField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
...
- 🔵 **paths** (`unrendered_json`): JSONField 'paths' has no sub-field references and no JsonCard in any layout
  - 💡 *Add a JsonCard for this JSONField, or individual sub-field form inputs if users need to edit its contents.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss report:paths:unrendered_json`
- 🔵 **config** (`unrendered_json`): JSONField 'config' has no sub-field references and no JsonCard in any layout
  - 💡 *Add a JsonCard for this JSONField, or individual sub-field form inputs if users need to edit its contents.*
...
Django fields: 30 | Pages: display(1)
...
- 🔵 **explanation** (`unrendered_field`): Django has 'explanation' (TextField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss setting:explanation:unrendered_field`
- 🔵 **is_locked** (`unrendered_field`): Django has 'is_locked' (BooleanField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
...
- 🔵 **paths** (`unrendered_field`): Django has 'paths' (JSONField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss setting:paths:unrendered_field`
- 🔵 **purpose** (`unrendered_field`): Django has 'purpose' (CharField) but no layout references it. Optional field — may be intentionally hidden.
  - 💡 *Add a form input (register/Controller) or ScalarCard entry for this field in the Detail page, or a column in the List page.  If intentionally hidden, dismiss it.*
...
- 🔵 **paths** (`unrendered_json`): JSONField 'paths' has no sub-field references and no JsonCard in any layout
  - 💡 *Add a JsonCard for this JSONField, or individual sub-field form inputs if users need to edit its contents.*
  - To dismiss: `manage.py ai_intelligence --task layout --dismiss setting:paths:unrendered_json`
- 🔵 **config** (`unrendered_json`): JSONField 'config' has no sub-field references and no JsonCard in any layout
  - 💡 *Add a JsonCard for this JSONField, or individual sub-field form inputs if users need to edit its contents.*
