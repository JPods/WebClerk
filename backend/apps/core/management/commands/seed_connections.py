...
CONNECTIONS = [
    ...
    },
    {
        ...
        'comment': (
            ...
            'Alice reviews before sending. WC_HQ reviews before distributing. '
            'Wisdom of the Many.'
        ),
        'config': {
            'channel': 'bundle',
    ...
    # -- Carrier connections (templates — user fills in credentials) ----------
    {
        ...
        'purpose': 'sync',
        'status': 'draft',
        'comment': 'UPS REST API. How to connect: https://webclerk.com/wc-works/connections/ups.html — get credentials at developer.ups.com, enter them here, set status=active.',
        'config': {
            'carrier_code': 'ups',
    ...
    },
    {
        ...
        'purpose': 'sync',
        'status': 'draft',
        'comment': 'FedEx REST API. How to connect: https://webclerk.com/wc-works/connections/fedex.html — get credentials at developer.fedex.com, enter them here, set status=active.',
        'config': {
            'carrier_code': 'fedex',
    ...
    },
    {
        ...
        'purpose': 'sync',
        'status': 'draft',
        'comment': 'USPS REST API. How to connect: https://webclerk.com/wc-works/connections/usps.html — get credentials at developer.usps.com, enter them here, set status=active.',
        'config': {
            'carrier_code': 'usps',
    ...
    # -- Cash connections ---------------------------------------------------
    {
        ...
        'comment': (
            ...
            'processes cards. Webhooks update Cash records. WC3 produces GL '
            'journal entries from completed cash — never holds card data.'
        ),
        'config': {
            'provider': 'stripe',
            'credentials': {
        ...
        'metadata': {
            'established': '2026-08-09',
            'class': 'cash',
            'doc': 'readmes/connections/cash.md',
        },
    },
    {
        'ida': 'conn-pay-square',
        ...
        'comment': (
            ...
            'cash requests, Square processes, webhooks update Cash records, '
    ...
    },
    {
        ...
        'comment': (
            ...
            'IPN/webhook updates WC3 Cash record. WC3 produces GL journal entries.'
        ),
        'config': {
            'provider': 'paypal',
            'credentials': {
    ...
    # -- Accounting connections ------------------------------------------------
    {
        ...
        'comment': (
            ...
            'production data (sales, cash, inventory). Journal entries export '
    ...
    # -- Banking connections ---------------------------------------------------
    {
        ...
        'comment': (
            ...
            'transactions, matches to invoices and cash_entries. Alice learns '
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--only', default='', help='Comma-separated connection idas to seed (e.g. conn-carrier-ups,conn-carrier-usps)')
