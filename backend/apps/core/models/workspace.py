...
Each workspace is a self-contained functional area: Apply Cash,
...
Usage:
    ...
    ws = Workspace.objects.get(ida='apply_cash')
...
class Workspace(BaseModel):
    ...
    # ── Identity ──────────────────────────────────────────────────────
    name = models.CharField(max_length=255, help_text="Display name (e.g. 'Apply Cash')")
    component = models.CharField(
        max_length=255, blank=True,
        help_text="React component path (e.g. 'apps/accounting/ApplyCash')",
    )
    ...
    route = models.CharField(
        max_length=255, blank=True,
        help_text="URL route segment (e.g. '/app/apply-cash')",
    )
