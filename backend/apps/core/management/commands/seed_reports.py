...
REPORTS = [
    ...
    # ── Invoices ──
    {'model_name': 'invoice', 'name': 'Invoice', 'description': 'Standard invoice with line items, totals, and cash terms', 'output_type': 'print', 'category': 'report', 'sort_order': 1, 'config': {'template': 'invoice', 'route': '/transactions/invoice/print/{id}'}},
    ...
    {'model_name': 'invoice', 'name': 'Past Due Notice', 'description': 'Past due cash reminder with aging details', 'output_type': 'print', 'category': 'statement', 'sort_order': 3, 'config': {'template': 'past_due_notice'}},
    ...
    # ── Cash ──
    {'model_name': 'cash', 'name': 'Cash Receipt', 'description': 'Cash receipt for customer', 'output_type': 'print', 'category': 'report', 'sort_order': 1, 'config': {'template': 'cash_receipt'}},
    {'model_name': 'cash', 'name': 'Cash Journal', 'description': 'Cash journal by date range', 'output_type': 'print', 'category': 'report', 'sort_order': 2, 'config': {'template': 'cash_journal'}},
    {'model_name': 'cash', 'name': 'Disbursement Report', 'description': 'AP disbursements by vendor and date', 'output_type': 'print', 'category': 'report', 'sort_order': 3, 'config': {'template': 'disbursement_report'}},
