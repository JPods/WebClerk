...
ROLE_DEFAULTS: dict[str, dict[str, Any]] = {
        ...
        "models": {
            "order": {
                ...
                "view_fields": [
                    ...
                    "totals", "totals.amount", "totals.tax", "totals.total",
                ...
                "edit_fields": [],
                # Reorder from the portal. The transaction save guard forces
                # customer_id to the user's org, status=planned, and server pricing.
                "allow_create": False,
                "allow_delete": False,
            },
            "invoice": {
            ...
            "item": {
                "query_filters": {},
                # Their price, not every tier: $user.price_level resolves to the
                # price level of the customer's org (Bill, 2026-09-17).
                "view_fields": [
                    "id", "ida", "name", "description", "sku", "kind", "uom",
                    "price.$user.price_level",
                    "catalog",
                ],
                "view_deny": ["cost", "price.base", "price.msrp", "price.retail",
                              "price.wholesale", "price.distributor", "price.qty_breaks"],
                "edit_fields": [],
                "allow_create": False,
                "allow_delete": False,
            },
            "contact": {
                ...
                "view_fields": "*",
                # Editing is staff-only for now (Bill, 2026-09-17). Self-service on a
                # portal contact's own details was the one exception; restore it when
                # the role split has been tested.
                "edit_fields": [],
                "allow_create": False,
                "allow_delete": False,
            },
    ...
    "user_vendor": {
        "is_portal": True,
        "description": "Vendor portal user - view their POs and the inventory they supply",
        # A vendor never sees what we sell for; their own last cost is the only cost
        # figure they see (Bill, 2026-09-17).
        "restricted_fields": {
            "view_deny": ["price", "cost.standard", "cost.avg", "cost.landed"],
            "negative_quantity": False,
        },
        "models": {
            "purchase": {
            ...
            "item": {
                ...
                # Inventory so the vendor can keep the customer never over and never
                # short, plus their own last cost. No prices (Bill, 2026-09-17).
                "view_fields": [
                    "id", "ida", "uuid", "name", "description", "sku",
                    "quantity.on_hand", "quantity.available", "quantity.on_po",
                    "quantity.min", "quantity.max",
                    "quantity.min",                    "cost.last",
                ],
                "view_deny": ["price", "cost.standard", "cost.avg", "cost.landed",
                              "cost.components", "cost.qty_breaks", "cost.history"],
                "edit_fields": [],
                "allow_create": False,
                "allow_delete": False,
            },
