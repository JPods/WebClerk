...
export const modelRegistry: ModelRegistration[] = [
  ...
  { app: "transactions", model: "quote", label: kebabCaseToTitle("quote") },
  { app: "transactions", model: "quote_line", label: kebabCaseToTitle("quote_line") },
  ...
  { app: "transactions", model: "cash", label: kebabCaseToTitle("cash") },
