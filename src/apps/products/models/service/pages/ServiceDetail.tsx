...
import { Wrench, Calendar, FileText, DollarSign, CheckSquare, MessageSquare, FileIcon, History, Link, Code } from "lucide-react";
...
function ServiceDetail({
  ...
  // Tab navigation
  const { activeTab, setActiveTab } = useDetailTabs("service_detail", "actions", [
  ...
  return (
    <>
      ...
      <SimpleDetailHeader
        ...
        mode={currentMode}
        backUrl={inline ? undefined : "/products/services"}
      />
        ...
        <div className="mt-4 space-y-0">
          <ScalarCard
            ...
            fields={[
              ...
              { label: "cost", value: data.cost, isCurrency: true },
