...
INFRASTRUCTURE_MODELS = {"core.RoleConfig", "core.ModelRoleConfig", "core.Report", "accounts.Currency", "accounts.Term", "accounts.GlAccount"}
...
def sanitize_setting(setting: dict) -> dict:
    """Remove company-identifying and payment-account details from Settings in a public bundle."""
    purpose = setting.get("purpose")
    config = setting.get("config") or {}
    if purpose == "wc:payment_gateway":
