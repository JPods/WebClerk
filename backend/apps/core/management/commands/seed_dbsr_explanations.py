...
PURPOSE_EXPLANATIONS = {
    ...
    'wc:cash_gateway': (
        'Cash gateway configuration — processor credentials, supported '
        'methods, and transaction settings. Controls how online cash '
...
REPORT_CATEGORY_EXPLANATIONS = {
    ...
    'statement': (
        ...
        'and balance — open invoices, cash received, aging buckets. '
