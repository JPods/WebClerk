...
export const protectedRoutesConfig = [
  ...
  { path: PageRoutes.receivableList, element: <ReceivableList /> },
  { path: PageRoutes.tallySummaryList, element: <TallySummaryList /> },
  { path: PageRoutes.salesDimensionTallyList, element: <SalesDimensionTallyList /> },
  { path: PageRoutes.inventoryUsageTallyList, element: <InventoryUsageTallyList /> },
  { path: PageRoutes.tallyRegistryList, element: <TallyRegistryList /> },
