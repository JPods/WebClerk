...
export const DYNAMIC_LISTS: SelectListDef[] = [
  {
    ...
    options: toOptions([
      ...
      ['3Pay30Days', '3 Cash every 30 days'],
      ['Dec1', 'Due Dec 1'],
      ['On Order', 'Cash due on order'],
      ['Net 60', 'Net 60 days'],
      ['Net 90', 'Net 90 days'],
...
export const TERM_RECORDS: TermRecord[] = [
  ...
  { id: 3,  name: '3Pay30Days',  description: '3 Cash every 30 days',      daysDue: 30, discountRate: null, daysDiscount: null, periodCount: 3, daysInPeriod: 30   },
  { id: 4,  name: 'Dec1',             description: 'Due Dec 1',                     daysDue:  1, discountRate: null, daysDiscount: null, periodCount: 1, daysInPeriod: null },
  { id: 5,  name: 'On Order',         description: 'Cash due on order',          daysDue:  0, discountRate: null, daysDiscount: null, periodCount: 1, daysInPeriod: null },
  ...
  { id: 9,  name: 'Prepaid',          description: 'Cash in advance',            daysDue:  0, discountRate: null, daysDiscount: null, periodCount: 1, daysInPeriod: null },
