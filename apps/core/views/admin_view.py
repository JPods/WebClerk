...
from apps.core.view_config import VIEW_CONFIG
# from apps.core.utils import get_list_display_fields
# If get_list_display_fields is defined elsewhere, update the import accordingly.
# For example, if it's in core.view_utils, use:
# from apps.core.view_utils import get_list_display_fields
