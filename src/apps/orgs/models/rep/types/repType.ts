/**
 * Rep Types — matches wc3 OrgBase (proxy: org_type="rep")
...
export interface UpdateRepRequest extends Partial<CreateRepRequest> {
  id: number;
  version?: number;
}

export type RepType = Organization & { org_type: "rep" };
