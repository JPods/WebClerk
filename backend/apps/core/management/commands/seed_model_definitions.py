...
SELL_LINE_LIST_COLUMNS = [
    ...
    _lc('totals.amount', width=90, align='right', format='currency'),
...
EXEC_LINE_LIST_COLUMNS = [
    ...
    _lc('totals.cost', width=90, align='right', format='currency'),
    _lc('status', width=80), _lc('comments.process', width=200),
]
...
def _build_columns(model_key, field_map):
    ...
    JSON_ENVELOPES = {
        ...
        'updated_by', 'end_by', 'languages', 'path',
