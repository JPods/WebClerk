...
export default function OrderDetailPage({ modeProp, dataProp, hideBreadcrumb, onSaved, inline = false, onCancelInline }: ContactAddProps) {
  ...
  return (
    <>
      {!hideBreadcrumb && !inline && <PageBreadcrumb pageTitle={mode === 'edit' ? 'Edit Action' : mode === 'view' ? 'View Action' : 'Add Orders'} />}
      <ComponentCard>
        {inline && (
          <div className="flex justify-between items-center mb-4">
            <h3 className=" dark:text-white text-lg font-semibold">
              {mode === 'edit' ? 'Edit Orders' : mode === 'view' ? 'View Orders' : 'Add New Orders'}
            </h3>
            {onCancelInline && (
