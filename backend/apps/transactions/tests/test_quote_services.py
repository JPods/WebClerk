...
class QuoteTotalsServiceTest(TestCase):
    """Test cases for unified totals engine on Quote."""
    ...
    def test_totals_empty_quote(self):
        """Test totals computation for quote with no lines."""
        self.quote.update_sell_cost_totals(persist=True)
    ...
    def test_totals_single_line(self):
        """Test totals computation for quote with single line item."""
    ...
    def test_totals_multiple_lines(self):
        """Test totals computation for quote with multiple line items."""
        QuoteLine.objects.create(
            quote=self.quote,
