...
Standard sizes:
  ...
  hr.jpg    — original resolution, detail page/zoom/print
...
SIZES = {
    ...
    'hr': {'max_height': None, 'max_width': None},  # original
}
...
def _set_cached_source(model_name: str, ida: str, source: str, size: str = None):
    ...
    try:
        ...
        if record:
            ...
            images = metadata.get('images') or {'source': '', 'tn': False, 'md': False, 'hr': False}
