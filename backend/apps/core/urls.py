...
from apps.core.views.inquiry_view import InquiryStartView, InquiryView
...
urlpatterns = [
    ...
    # What this user may see and change, and what the record's own state locks
    path("wcapi/<str:model_name>/fields/",
    ...
    path("wcapi/_inquiry/start/", InquiryStartView.as_view(), name="wcapi-inquiry-start"),
    path("wcapi/_inquiry/", InquiryView.as_view(), name="wcapi-inquiry"),
    # QA
    ...
    # Layout parade
    path("wcapi/_layout_parade/", LayoutParadeView.as_view(), name="wcapi-layout-parade"),
    # Component parade
    path("wcapi/_component_parade/", ComponentParadeView.as_view(), name="wcapi-component-parade"),
    path("wcapi/_component_parade_preview/", ComponentParadePreviewView.as_view(), name="wcapi-component-parade-preview"),
    # Test parade
    ...
    path("wcapi/hooks/review/", HookClearanceView.as_view(), name="wcapi-hook-review"),
    path("wcapi/hooks/submit/", HookSubmitView.as_view(), name="wcapi-hook-submit"),
