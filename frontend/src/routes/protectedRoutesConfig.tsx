...
import ComponentParade from "../pages/tools/ComponentParade";
import LayoutWorkbench from "../pages/tools/LayoutWorkbench";
import SelectListBrowser from "../pages/tools/SelectListBrowser";
import AgendaView from "../pages/admin/AgendaView";
import ApplyCash from "../apps/transactions/pages/ApplyCash";
...
export const protectedRoutesConfig = [
  ...
  { path: PageRoutes.transactionsApplyCash, element: <ApplyCash /> },
  { path: PageRoutes.transactionsCashList, element: <Navigate to="/cash" replace /> },
  { path: PageRoutes.transactionsCashDetail, element: <S><UiDetail modelName="cash" /></S> },
  ...
  { path: PageRoutes.kanbanBoard, element: <S><KanbanBoardPageLazy /></S> },
  { path: PageRoutes.kanbanBoardData, element: <KanbanBoardDataPage /> },
  { path: PageRoutes.gantt, element: <S><UnifiedGanttPageLazy /></S> },
  ...
  { path: PageRoutes.componentParade, element: <ComponentParade /> },
  { path: PageRoutes.layoutWorkbench, element: <LayoutWorkbench /> },
