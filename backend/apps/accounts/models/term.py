...
class Term(BaseModel):
    """
    Cash Terms Configuration
    ===========================
    
    Defines how invoice cash are scheduled and when they're due.
    ...
    Net 30 (single installment, 30 days):
    ...
    Fixed Date (cash_entries due on specific date):
    ...
    period_count = models.IntegerField(
        ...
        help_text="Number of installments (1=single installment)")
    days_due = models.IntegerField(
        blank=True, null=True,
        help_text="Days until cash due (from invoice or dt_begin)")
