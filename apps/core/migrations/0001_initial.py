    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.JSONField(default=common.models.default_comments, help_text='Threaded notes / comment fields')),
                ('health_rating', models.IntegerField(default=0, help_text='Data quality rating (0-100)')),
                ('action_en', models.CharField(blank=True, max_length=255, null=True)),
                ('action_ar', models.CharField(blank=True, max_length=255, null=True)),
                ('action_bn', models.CharField(blank=True, max_length=255, null=True)),
                ('action_es', models.CharField(blank=True, max_length=255, null=True)),
