...
export function getFrontendDataSet(): DataSetInfo {
  return {
    id: String(import.meta.env.VITE_DATA_SET_ID || 'UNKNOWN').replace(/['"]/g, ''),
    name: String(import.meta.env.VITE_DATA_SET_NAME || 'Unknown').replace(/['"]/g, ''),
  };
}
 ...
 */
export function logDataSetInfo(frontend: DataSetInfo, backend?: SystemInfo): void {
