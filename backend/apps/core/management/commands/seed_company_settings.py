...
COMPANY_PROFILE_CONFIG = {
    ...
    "receivables": {
        ...
        "messages": {
            "period_1": {
                "heading": "Our records show that we have not registered cash for the Invoice(s) listed below",
                "closing": "We would appreciate cash of these items within the next few days.",
            },
            "period_2": {
                "heading": "The following invoices are significantly past due",
                "closing": "Please remit cash immediately or contact us to discuss cash arrangements.",
            },
            "period_3": {
                "heading": "FINAL NOTICE — The following invoices are seriously delinquent",
                "closing": "Immediate cash is required to avoid further collection action.",
            },
        },
        "conditions": {
    ...
    "onboarding": {
        ...
        "pain_points": [],               # data_entry, finding_info, reports, inventory_accuracy, cash_tracking, multi_location, integrations
