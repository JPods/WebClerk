...
export function ModelDataPanel({ data, showScalars = true, grouped = false, onSelectCategory, }: { data: any; showScalars?: boolean; grouped?: boolean; onSelectCategory?: (tabId: string) => void }) {
