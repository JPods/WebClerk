...
LAYOUTS = {
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "fields": [
                            ...
                            _f("allocations.freight", format="currency"),
                            _f("allocations.duty", format="currency"),
                            _f("allocations.handling", format="currency"),
                            _f("allocations.vat", format="currency"),
                            _f("allocations.method.freight"),
                            _f("allocations.method.duty"),
                            _f("allocations.method.handling"),
                            _f("allocations.method.vat"),
                            _f("totals.total", format="currency"),
                            _f("totals.paid", format="currency"),
                            _f("totals.balance", format="currency"),
                        ],
                        "action_summary": True,
                    },
                ],
    ...
    "document": {
        ...
        "sections": [
            ...
            {"type": "panel", "content": "notes", "label": "comments"},
            {"type": "json_tree", "label": "json", "collapsed": True,
             "fields": ["path", "config", "metadata", "refs", "prefs"]},
        ],
        "edit_rules": ORG_EDIT_RULES,
    },
