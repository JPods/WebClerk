...
/**
 * AiHelpWidget.tsx — Alice, the WebClerk commerce assistant.
 *
 * Floating chat widget with mode switching and console error capture.
 * Alice helps users with commerce questions and developers with code.
 *
 * Usage in Router.tsx:
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev.slice(0, -1),
        {
          role: "assistant",
          content:
            "Sorry, I can't answer right now — the AI service may not be running.",
        },
      ]);
    } finally {
      setIsLoading(false);
      ...
      try {
        ...
        setMessages((prev) => [
          ...prev.slice(0, -1),
          {
            role: "assistant",
            content:
              "Sorry, I can't analyze that error right now — the AI service may not be running.",
          },
        ]);
      } finally {
        setIsLoading(false);
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        {messages.length === 0 && (
          <div className="text-center text-gray-400 text-sm mt-8">
            ...
            <p className="font-medium">Alice — WebClerk Assistant</p>
