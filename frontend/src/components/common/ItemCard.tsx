      ...
      {item && !loading && (
        <div style={{
          ...
          <div style={{ padding: '8px 12px', borderRight: '1px solid var(--wc-border, #dee2e6)' }}>
            ...
            <Row label="price.retail" value={fmt(item.price?.retail)} mono />
            <Row label="price.wholesale" value={fmt(item.price?.wholesale)} mono />
            <Row label="cost.standard" value={fmt(item.cost?.standard)} mono />
            <Row label="cost.last" value={fmt(item.cost?.last)} mono />
