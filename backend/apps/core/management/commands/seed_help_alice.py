...
COMPONENTS = [
    ...
    },
    {
        ...
        'description': 'Organization financials — AR/AP balances, cash history, aging.',
        'body': (
            'Shows financial summary for any org type: outstanding balance, cash history, '
    ...
    },
    {
        ...
        'body': (
            'Customer-specific fields beyond the base org: price level, cash terms, '
    ...
    },
    {
        ...
        'body': (
            ...
            'cash_entries applied, balance due. Updates in real-time as lines change. '
    ...
    },
    {
        ...
        'description': 'Transaction actions modal — convert, ship, apply cash.',
        'body': (
            'Manages transaction lifecycle actions: Convert to Order, Convert to Invoice, '
            'Ship Order, Apply Cash, Print. Each action calls a manage_view endpoint. '
            'Available actions depend on transaction type and status.'
        ),
    },
    {
        'name': 'AddCashModal',
        'source': 'apps/transactions/components/AddCashModal.tsx',
        'description': 'Add cash dialog — record cash against an invoice.',
        'body': (
            'Create a new cash record: amount, method, reference number, date. '
            'Cash applies against the selected invoice. Backend creates the Cash '
