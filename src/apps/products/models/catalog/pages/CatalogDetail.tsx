...
import { BookOpen, FolderTree, FileText, DollarSign, CheckSquare, MessageSquare, FileIcon, History, Link, Code } from "lucide-react";
...
function CatalogDetail({
  ...
  // Tab navigation
  const { activeTab, setActiveTab } = useDetailTabs("catalog_detail", "actions", [
  ...
  return (
    <>
      ...
      <SimpleDetailHeader
        ...
        mode={currentMode}
        backUrl={inline ? undefined : "/products/catalogs"}
      />
...
export default withDevIdentifier(CatalogDetail, 'CatalogDetail');
