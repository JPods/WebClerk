...
# ---------------------------------------------------------------------------
# update_paid — AP payment-side balance update (mirrors update_received)
# ---------------------------------------------------------------------------
...
def update_paid(
    ...
    AP mirror of update_received(). Called by payment_pending_receipt after
    a cash_out payment is applied or unapplied. This is the ONLY function
