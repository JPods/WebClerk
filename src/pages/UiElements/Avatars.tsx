...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | WebClerk - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for WebClerk - React.js Tailwind CSS Admin Dashboard Template"
      />
