...
Architecture (established 2026-08-04):
  ...
  FinancialMetadataMixin — GL, reconciliation, ledger (transactions, cash)
...
# ═══════════════════════════════════════════════════════════════════════
# Financial mixin — transactions + cash_entries only
# ═══════════════════════════════════════════════════════════════════════
...
class FinancialMetadataMixin(BaseModel):
    """Mixed into transaction/cash metadata. Not on contacts or items."""
