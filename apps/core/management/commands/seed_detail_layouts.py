    ...
    "receipt": {
        ...
        "sections": [
                ...
                "columns": [
                    {
                        ...
                        "title_ida": True,
                        "fields": [
                            {"field": "purchase.company", "label": "Company"},
                            {"field": "purchase.phone", "label": "Phone"},
                            {"field": "purchase.attention", "label": "Attn"},
                            {"field": "purchase.address_full", "label": "Address"},
                            {"field": "purchase.email", "label": "Email"},
                        ],
                    },
                    {
                        "title": "Receiving",
                        "fields": [
                            ...
                            {"field": "dt_received", "label": "Received"},
                            {"field": "purchase.ida", "label": "PO #", "link": True},
                            {"field": "config.ship_to.company", "label": "Ship To"},
                            {"field": "config.ship_to.address1", "label": "Address"},
                            {"field": "config.ship_to.city_state_zip", "label": "City/State"},
                        ],
                    },
                    {
                        ...
                        "fields": [
                            {"field": "status", "label": "Status"},
                            {"field": "dt_created", "label": "Created"},
                            {"field": "source_name", "label": "Receiver"},
                            {"field": "priority", "label": "Priority"},
                            {"field": "vendor_invoice_amount", "label": "Vendor Inv", "format": "currency"},
                            {"field": "vendor_invoice_freight", "label": "Freight", "format": "currency"},
                            {"field": "duty", "label": "Duty", "format": "currency"},
                            {"field": "handling", "label": "Handling", "format": "currency"},
                            {"field": "vat", "label": "VAT", "format": "currency"},
                            {"field": "allocation_method", "label": "Allocate By"},
                        ],
                        "action_summary": True,
                    },
                ],
            ...
            {"type": "line_card", "family": "exec", "toolbar": ["L", "S", "XR"],
             "line_columns": [
                 {"field": "item.description", "label": "Item", "flex": 3},
                 {"field": "item.item_id", "label": "Item #", "flex": 1},
                 {"field": "quantity.ordered", "label": "Ordered", "flex": 1, "align": "right"},
                 {"field": "quantity.staged", "label": "Received", "flex": 1, "align": "right"},
                 {"field": "cost.unit", "label": "Unit Cost", "flex": 1, "align": "right", "format": "currency"},
                 {"field": "cost.extended", "label": "Extended", "flex": 1, "align": "right", "format": "currency"},
                 {"field": "cost.landed_per_unit", "label": "Landed", "flex": 1, "align": "right", "format": "currency"},
                 {"field": "warehouse_name", "label": "Warehouse", "flex": 1},
                 {"field": "lot", "label": "Lot #", "flex": 1},
                 {"field": "serial_batch", "label": "Serial/Batch", "flex": 1},
             ],
             "actions": []},
            {"type": "tabs", "tabs": [
                {"label": "Summary", "content": "summary"},
                {"label": "Inspect", "content": "inspect"},
                {"label": "Variances", "content": "variances"},
                {"label": "QA", "content": "qa"},
                {"label": "Actions", "content": "actions"},
                {"label": "Documents", "content": "documents"},
                {"label": "Notes", "content": "notes"},
