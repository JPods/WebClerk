...
import {
  FaPlay, FaTrash, FaSync, FaBoxOpen,
...
const STEP_CONFIG = [
  ...
  },
  {
    label: "Record Cash",
    icon: <FaDollarSign />,
    coaching: "Cash reduces the invoice balance. No inventory effect — cash is financial, not physical. The invoice's totals.cash_state becomes 'paid' or 'partial'; status stays the workflow state.",
