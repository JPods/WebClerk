/* LastChecked: 2026-03-14 | WhereUsed: TODO(wc3-schema-audit) | WhoCreated: Unknown */
  ...
  static readonly layoutParade: string = "/layout-parade";
  static readonly testParade: string = "/test-parade";
  static readonly componentParade: string = "/component-parade";
  static readonly layoutWorkbench: string = "/layout-workbench";
  ...
  static readonly transactionsApplyCash: string =
    "/transactions/apply-cash";

  static readonly transactionsCashList: string =
    "/transactions/cash/list";
  static readonly transactionsCashDetail: string =
    "/transactions/cash/detail/:id?";
  ...
  static readonly reportSummaryList: string = "/accounts/report-summary/list";
  static readonly reportSalesList: string = "/accounts/report-sales/list";
  static readonly reportInventoryList: string =
    "/accounts/report-inventory/list";
  static readonly reportRegistryList: string = "/accounts/report-registry/list";
