...
const WCHQ_RESOURCES: HelpItem[] = [
  ...
  { id: 'wchq-4', title: 'MCP Server Templates', body: 'Downloadable MCP server templates for common integrations: tax, shipping, cash, time tracking.', source: 'wchq', category: 'developer', url: 'https://webclerk.net/videos.html' },
