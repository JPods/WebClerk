...
Transactions, cash, inventory, ledger, commissions, forecasting —
...
WC3_COMMERCE_DOCS = [
    {
        ...
        'qq_movie': 'qq_movie_here_2026-08-12: 4-min transaction lifecycle — create order, add lines, convert to invoice, apply cash',
    },
    {
    ...
    },
    {
        ...
        'description': 'GL posting and cash/cash balance management — the accounting backbone',
        'git_path': 'readmes/ledger-financial-system.md',
        'sequence': 330,
        'tags': ['wc3', 'commerce', 'ledger', 'gl', 'accounting'],
        'qq_movie': 'qq_movie_here_2026-08-12: 3-min GL posting walkthrough — invoice creates journal, cash settles, trial balance',
    },
    {
        'ida': 'WC3-COM-CASH_ENTRIES',
        'name': 'Cash Application Design',
        'description': 'Cash processing — application, posting, reconciliation, Spreedly integration',
        'git_path': 'readmes/cash-application-design.md',
        'sequence': 340,
        'tags': ['wc3', 'commerce', 'cash_entries', 'spreedly'],
        'qq_movie': 'qq_movie_here_2026-08-12: 2-min cash application — apply cash to invoice, partial payment, overpayment',
    },
    {
    ...
    },
    {
        ...
        'description': 'Organization financial objects — AR/AP, credit limits, cash terms, aging',
