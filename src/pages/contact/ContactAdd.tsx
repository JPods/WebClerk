...
export default function ContactAdd() {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle={mode === 'edit' ? 'Edit Action' : mode === 'view' ? 'View Action' : 'Add Contact'} />
      <ComponentCard>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="priority">FirstName</Label>
              <Input
                type="text"
                id="priority"
            ...
            <div>
              <Label htmlFor="difficulty">LastName</Label>
              <Input
                type="text"
                id="difficulty"
