...
urlpatterns = [
    ...
    # Transaction endpoints: wcapi/<model_name>/... — no app name in the path.
    # Registered before apps.core.urls, whose wcapi/<model>/<field>/<from>/<to>/
    # range query would otherwise swallow them.
    path('wcapi/', include('apps.transactions.urls')),
