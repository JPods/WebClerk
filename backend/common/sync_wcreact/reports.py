...
REPORT_DEFS: dict[str, list[dict]] = {
    ...
    "customer": [
        ...
        {"name": "Customer Activity Report",        "description": "Orders, invoices, and cash_entries in period",      "output_type": "print", "category": "report",    "sort_order": 119},
        # -- email --
    ...
    "invoice": [
        ...
        {"name": "Invoice Paid By",                 "description": "Cash detail by invoice",                     "output_type": "print", "category": "report",    "sort_order": 120},  # wc2: Invoice Paid By
    ...
    # ===================================================================
    # CASH reports  (wc2: Cash table)
    # ===================================================================
    "cash": [
        {"name": "Cash Receipt",                 "description": "Confirmation of cash received",                 "output_type": "print",  "category": "report",  "sort_order": 5},
        {"name": "Period Cash Report",          "description": "Cash transactions for period",                  "output_type": "print",  "category": "report",  "sort_order": 10},   # wc2: Period Cash Report
        {"name": "Bank Deposit",                    "description": "Bank deposit report / slip",                        "output_type": "print",  "category": "report",  "sort_order": 20},   # wc2: Bank Deposit
        {"name": "Deposit Report",                  "description": "Cash to deposit grouped by method",            "output_type": "print",  "category": "report",  "sort_order": 25},
        ...
        {"name": "Cash Journal",                 "description": "Cash journal entries for period",               "output_type": "print",  "category": "report",  "sort_order": 35,  "role_required": "admin"},
        {"name": "Disbursement Report",             "description": "Disbursements / AP cash for period",           "output_type": "print",  "category": "report",  "sort_order": 40,  "role_required": "admin"},
        {"name": "Cash Export",                  "description": "Export cash to CSV",                            "output_type": "export", "category": "export",  "sort_order": 100},
    ],
