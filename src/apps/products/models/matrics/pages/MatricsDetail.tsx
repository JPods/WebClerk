...
import { BarChart3, Ruler, Hash, FileText, CheckSquare, MessageSquare, FileIcon, History, Link, Code } from "lucide-react";
...
function MatricsDetail({
  ...
  // Tab navigation
  const { activeTab, setActiveTab } = useDetailTabs("matrics_detail", "actions", [
  ...
  return (
    <>
      ...
      <SimpleDetailHeader
        ...
        mode={currentMode}
        backUrl={inline ? undefined : "/products/matrics"}
      />
...
export default withDevIdentifier(MatricsDetail, 'MatricsDetail');
