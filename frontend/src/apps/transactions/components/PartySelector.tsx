...
export type CustomerSelectorProps = Omit<PartySelectorProps, "partyType">;

export const CustomerSelector: React.FC<CustomerSelectorProps> = (props) => (
  <PartySelector {...props} partyType="customer" />
);

export type VendorSelectorProps = Omit<PartySelectorProps, "partyType">;

export const VendorSelector: React.FC<VendorSelectorProps> = (props) => (
  <PartySelector {...props} partyType="vendor" />
);

export type ManufacturerSelectorProps = Omit<PartySelectorProps, "partyType">;
