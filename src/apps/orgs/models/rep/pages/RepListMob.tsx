  ...
  return (
    <div className="flex-1 overflow-y-auto px-2">
      {dataProp && dataProp.length > 0 ? (
        dataProp.map((rep, index) => (
          <AccordionItem
            key={rep.id}
            title={`display_name: ${rep.display_name ?? "--"} (id: ${rep.id})`}
          ...
          >
            ...
            <div className="flex flex-col min-h-[220px]">
              ...
              <div className="space-y-1 text-sm">
                <p>
                  <strong>org_type:</strong> {rep.org_type || "--"}
                </p>
                <p>
        ...
        <p className="text-center text-gray-500">No rep found.</p>
      )}
    </div>
  );
}
