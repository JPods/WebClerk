...
export const MODEL_REPORTS: Record<string, ReportDef[]> = {
  ...
  customer: [
    ...
    { name: 'Aged Receivable Report', description: 'Aged receivable report by customer', output_type: 'print', category: 'report', sort_order: 20, data: { endpoint: '/wcapi/reports/aged_receivables/', layout: 'aged_receivables' } },
    ...
    { name: 'Statement', description: 'Customer account statement', output_type: 'print', category: 'statement', sort_order: 80, data: { endpoint: '/wcapi/reports/statement/{id}/', layout: 'statement' } },
  ...
  invoice: [
    ...
    { name: 'Rep - Sales/Comm Earned', description: 'Rep sales and commissions earned', output_type: 'print', category: 'report', sort_order: 180, role_required: 'admin' },
    { name: 'Rep (Ind) - Sales/Comm Earned', description: 'Individual rep sales/commission', output_type: 'print', category: 'report', sort_order: 190, role_required: 'admin' },
  ...
  // =========================================================================
  // REP  (wc2: Reps — commission reports live here)
  // =========================================================================
  rep: [
    { name: 'Commission Statement', description: 'Individual rep commission statement with invoice detail', output_type: 'print', category: 'report', sort_order: 10, role_required: 'admin' },
    { name: 'Commission Summary', description: 'All reps commission summary for period', output_type: 'print', category: 'report', sort_order: 20, role_required: 'admin' },
    { name: 'Sales Credited by Rep', description: 'Sales credited to rep with customer breakdown', output_type: 'print', category: 'report', sort_order: 30, role_required: 'admin' },
    { name: 'Rep Contact List', description: 'Rep directory with contacts', output_type: 'print', category: 'list', sort_order: 40 },
    { name: 'Rep Export', description: 'Export rep data to CSV', output_type: 'export', category: 'export', sort_order: 200 },
  ],
  ...
  employee: [
    ...
    { name: 'Employee Commission Statement', description: 'Employee commission statement with invoice detail', output_type: 'print', category: 'report', sort_order: 20, role_required: 'admin' },
