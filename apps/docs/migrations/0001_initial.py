    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linkage_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='index_entries', to='docs.linkage')),
            ],
            options={
                'db_table': 'linkage_index',
                'indexes': [models.Index(fields=['linkage_id'], name='linx_lkg_idx'), models.Index(fields=['table_name', 'linkage_id'], name='linx_tbl_lkg_idx')],
                'constraints': [models.UniqueConstraint(fields=('table_name', 'record_id'), name='uniq_linkage_index_pair')],
            },
        ),
        migrations.CreateModel(
            name='QuestionAnswer',
            fields=[
                ...
                ('count_accessed', models.IntegerField(default=0)),
                ('search_vector', django.contrib.postgres.search.SearchVectorField(editable=False, null=True)),
                ('contact_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='qa_answers', to=settings.AUTH_USER_MODEL)),
                ('setting_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='qa_questions', to='core.setting')),
            ],
            options={
                'db_table': 'qas',
