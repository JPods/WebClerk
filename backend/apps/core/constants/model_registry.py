...
MODEL_REGISTRY: Dict[str, ModelMeta] = {
    ...
    'pending': ModelMeta('pending', 'apps.core.models.pending.Pending', 'Pending', 'Pending', 'pending', kind='support', aliases=[]),
    ...
    'cash': ModelMeta('cash', 'apps.transactions.models.Cash', 'Cash', 'Cash', 'cash', kind='header', aliases=['cash_entry', 'cash_entries']),
