...
import { Warehouse, User, MapPin, Package, CheckSquare, MessageSquare, FileIcon, History, Link, Code } from "lucide-react";
...
export default function WarehouseDetail({
  ...
  // Tab navigation
  const { activeTab, setActiveTab } = useDetailTabs("warehouse_detail", "actions", [
  ...
  return (
    <>
      ...
      <SimpleDetailHeader
        ...
        mode={currentMode}
        backUrl={inline ? undefined : "/products/warehouses"}
      />
