...
class LedgerAdmin(ScalarFirstFieldsetMixin, SchemaLabelsAdminMixin, admin.ModelAdmin):
	# Scalar fields: discount_potential, dt_created, dt_discount_due, dt_due, dt_modified, dt_recorded, health_rating, ida, is_active, is_archived, is_deleted, is_locked, is_settled, model_name, parent_id, security_level, source, uuid, value_available, value_original, version
	list_display = ("ida", "value_original", "value_available", "dt_due", "dt_recorded", "source", "model_name", "dt_created")
	list_filter = ("source", "model_name", "is_active")
	search_fields = ("ida",)
