...
def accrue_manufacturer_rebate(
    ...
    receivable = role_account('other_receivables', used_by=f'rebate accrual for manufacturer {manufacturer_id}')
    income = role_account('other_income', used_by=f'rebate accrual for manufacturer {manufacturer_id}')
