    ...
    panels: list[EnrichmentPanel] = Field(default_factory=lambda: [
        ...
        EnrichmentPanel(
            ...
            fields=[
                ...
                PanelField(field='min', label='Reorder Point', format='number'),
                PanelField(field='max', label='Max Stock', format='number'),
            ],
        ),
        EnrichmentPanel(
            key='pricing',
    ...
    panels: list[EnrichmentPanel] = Field(default_factory=lambda: [
        ...
        EnrichmentPanel(
            ...
            fields=[
                ...
                PanelField(field='last.dt_last_cash', label='Last Cash', format='date'),
            ],
        ),
        EnrichmentPanel(
            key='relationships',
