"""
seed_terms — Seed standard cash terms.
...
TERMS = [
    ...
    {'ida': 'Prepaid',      'name': 'Prepaid',      'description': 'Cash in Advance',            'days_due': 0,  'discount_rate': 0, 'days_discount': 0, 'period_count': 1, 'days_in_period': 0},
    ...
    {'ida': '3Pay30Days',   'name': '3Pay30Days',   'description': '3 Cash Every 30 Days',      'days_due': 90, 'discount_rate': 0, 'days_discount': 0, 'period_count': 3, 'days_in_period': 30},
    {'ida': 'CreditCard',   'name': 'CreditCard',   'description': 'Credit Card Cash',           'days_due': 0,  'discount_rate': 0, 'days_discount': 0, 'period_count': 1, 'days_in_period': 0},
]


class Command(BaseCommand):
    help = 'Seed standard cash terms (12 terms)'
