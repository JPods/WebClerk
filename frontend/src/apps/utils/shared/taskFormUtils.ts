...
export const createInitialTaskFormState = (
  ...
  // ActionModelFields
  actions: {},
  // TaskFormState fields
  translations: [createTranslationEntry("en")],
  columnId,
  projectId: undefined,
  priority: "medium",
  priority_value: 2, // medium
  dt_start: "",
  dt_deadline: "",
  dt_completed: "",
  dt_expected: "",
  ...
  percent_complete: String(DEFAULT_PROGRESS),
  difficulty_value: String(DEFAULT_DIFFICULTY),
  progress_value: String(DEFAULT_PROGRESS),
  status_code: "",
});
