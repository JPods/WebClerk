# Generated by Django 5.2.5 on 2025-11-19 17:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.JSONField(default=dict, help_text='Universal metadata envelope')),
                ('refs', models.JSONField(default=dict, help_text='Keywords / tags / lightweight links')),
                ('prefs', models.JSONField(default=dict, help_text='User preferences / settings')),
                ('actions', models.JSONField(blank=True, default=dict, help_text='Next action metadata (searchable)')),
                ('comments', models.JSONField(default=dict, help_text='Threaded notes / comment fields')),
