"""
common.sync_wcreact.terms — Canonical cash term definitions and sync logic.

Defines the master list of cash terms (mirroring r25 TERM_RECORDS in
...
TERM_DEFS = [
    ...
    {
        "name": "3Pay30Days",
        "description": "3 Cash every 30 days",
        "days_due": 30,
        "period_count": 3,
        "days_in_period": 30,
    },
...
def list_terms(stdout):
    ...
    for t in terms:
        ...
        if t.period_count and t.period_count > 1:
            periods = f", {t.period_count} cash_entries q/{t.days_in_period}d"
        stdout.write(
