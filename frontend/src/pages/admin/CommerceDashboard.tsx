...
function SalesTab({ data, filters }: { data: any; filters: Filters; themeKey: string }) {
...
function PurchasingTab({ data, filters }: { data: any; filters: Filters; themeKey?: string }) {
      ...
      {(stale.invoices > 0 || stale.cash_entries > 0 || stale.purchases > 0) && (
        <div className="cd-section">
          ...
          <div className="cd-metrics-row">
            ...
            {stale.cash_entries > 0 && (
              <div className="cd-metric cd-metric--clickable" onClick={() => openStaleInDbr('cash')}>
                <div className="cd-metric-value cd-metric-value--warn">{stale.cash_entries}</div>
                <div className="cd-metric-label">Cash</div>
                <div className="cd-metric-sub">Click to open in DataBrowser</div>
              </div>
            )}
            {stale.purchases > 0 && (
