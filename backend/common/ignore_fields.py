...
IGNORE_WORDS = {
    ...
    # Low-value label words frequently seen in denormalized metadata.
    "work", "home", "name", "label", "type",
    # Profanity / abusive tokens that should never become searchable keywords.
